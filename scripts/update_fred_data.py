...
- Fetches 31 FRED series (Treasury yields, spreads, policy rates, liquidity, inflation, breakeven, TIPS, Fed BS)
...
# 31 series — keep order consistent with historic layout
SERIES = [
    # Treasury yields (11)
    ...
    # Fed total assets (1) - added 2026-05-16 for Net Liquidity calc (WALCL - WDTGAL - RRPONTSYD)
    "WALCL",
    # Credit spread (1) - added 2026-06-16 for correction-type diagnostic (systemic vs positioning unwind)
    "BAMLH0A0HYM2",
]
